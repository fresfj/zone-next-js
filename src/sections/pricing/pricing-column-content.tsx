...
type PricingColumnContentProps = {
  sx?: SxProps<Theme>;
  plan: PricingCardProps;
};

export function PricingColumnContentMobile({ plan, sx }: PricingColumnContentProps) {
...
export function PricingColumnContentDesktop({ plan, sx }: PricingColumnContentProps) {
  const isStartLicense = plan.license === 'Start';
  const isProLicense = plan.license === 'Pro';
  const isBusinessLicense = plan.license === 'Business';
